...
def parse_args():
    ...
    parser.add_argument('--art_styles', type=str, default='art_styles/wave.jpg', help='File path of art_styles image (notation in the paper : a)', required=True)
    ...
    parser.add_argument('--style_weight', type=float, default=5e2, help='Weight of art_styles-loss')
    ...
    parser.add_argument('--style_layers', nargs='+', type=str, default=['relu1_1', 'relu2_1', 'relu3_1', 'relu4_1', 'relu5_1'],
                        help='VGG19 layers used for art_styles loss')
...
def check_args(args):
    ...
    try:
        ...
        print('art_styles weight must be positive')
    ...
    try:
        ...
        print('art_styles layer info and weight info must be matched')
        return None
...
def main():
    ...
    # create a map for art_styles layers info
    STYLE_LAYERS = {}
