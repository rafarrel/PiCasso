...
class StyleTransferTrainer:
    ...
    def _build_graph(self):
        ...
        self.y_s = tf.placeholder(tf.float32, shape=self.y_s0.shape, name='art_styles')
        ...
        # Get art_styles-layer-feature for art_styles loss
        style_layers = self.net.feed_forward(self.y_s_pre, scope='art_styles')
        self.As = {}
        ...
        for id in self.Fs:
            if id in self.CONTENT_LAYERS:
                ...
                G = self._gram_matrix(F, (b,N,M))   # Art_styles feature of x
                A = self.As[id]                     # Art_styles feature of a
